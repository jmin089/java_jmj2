...
public class J0920_04 {
	...
	public static void main(String[] args) {
		...
		//subString()
		System.out.println(str.substring(5,9));   //5번째 자리부터 9번째 앞까지가져오기.
		System.out.println(str.substring(5));     //5번째 자리부터 끝까지가져오기.
		
		String no = "com202311001";     //학번 com = 컴퓨터공학, 2023 = 입합년도, 11 = 담당교수, 001 = 번호
		//입학년도와 번호를 출력하세요.

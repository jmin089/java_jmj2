...
public class J0907_05_연금 {

	public static void main(String[] args) {
		//주택복권 1조12345                1조:0~9까지 번호:00000~99999
		...
		//1조 - 0~9
		//int fNo = (int)(Math.random()*10);       //0~9
		...
		String strNo = String.format("%05d", sNo); //0~99999를 00000~99999로 변경.
		//System.out.println(sNo);                 //시작이 0일때 삭제되고 나머지 나옴.(01234 -> 1234로 나옴)
